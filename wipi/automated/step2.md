...
![Tp-link modem setup](https://github.com/sayanadhikari/wipi/blob/automated/images/tp-link-3.png)
![Tp-link modem setup 2](https://github.com/sayanadhikari/wipi/blob/automated/images/tp-link-2.png)
:warning: If you already have a modem and want use this device as a router only, follow the instruction below:
![Tp-link modem setup 3](https://github.com/sayanadhikari/wipi/blob/automated/images/tp-link-1.png)
