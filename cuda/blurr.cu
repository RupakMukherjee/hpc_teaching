...
//  uchar4 inputRGBA = inputImageRGBA[pixel_pos];
//  redChannel[pixel_pos] = inputRGBA.x
//  greenChannel[pixel_pos] = inputRGBA.y
//  blueChannel[pixel_pos] = inputRGBA.z
}
...
//  const dim3 gridSize( numCols/24+1, numRows/24+1, 1);
